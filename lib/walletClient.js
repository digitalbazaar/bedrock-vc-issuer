...
exports.getControllerKey = async function({actor, accountId, account = null}) {
  ...
  // FIXME: add another layer where the KMS is used for each individual
  // account and the account has a zcapKey that an instance will delegate
  // zcaps to instead of the account's did:key directly for added security
