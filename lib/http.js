...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  const cfg = {
    routes: {
      ...
      claimUser: '/vc-issuer/claim-user',
    }
  };
  const {routes} = cfg;
  ...
  */
  ...
  app.post(
    ...
    asyncHandler(async (req, res) => {
      ...
      // TODO: use getControllerKey API to get did:key that will go into zcap
      // this API does not exist
      // await getControllerKey({actor: null, account});
