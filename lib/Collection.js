...
module.exports = class Collection {
  ...
  async create({item, meta}) {
    ...
    const edvDoc = await getEdvDocument({controllerKey, instance, capability});
  ...
  async update({item, meta, sequence}) {
    ...
    const edvDoc = await getEdvDocument(
      {controllerKey, instance, id: existing.id, capability});
...
async function getEdvDocument({controllerKey, instance, id, capability}) {
  ...
  const invocationSigner = await controllerKey.getAsymmetricKey(
