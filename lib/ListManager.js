...
export class ListManager {
  ...
  async _createNextStatusLists() {
    // FIXME: may need to store more than just SLC IDs... must store enough
    // information to enable every `credentialStatus` entry to be created
    // (but might be able to leverage `statusListConfig` for this)
