...
// const {
//   createList: createList2021,
//   createCredential: createSlc
// } = require('@digitalbazaar/vc-status-list');
const {
  // createList: createList2020
  createList,
...
export class ListManager {
  // FIXME: add list type; (revocation list 2020 or status list 2021)
  // FIXME: additionally, add `statusPurpose` ... which will be `revocation`
  // for rl 2020 and can be anything for status list 2021
  constructor({
    id, slcsBaseUrl, documentLoader, documentStore, issuer, suite
  } = {}) {
    assert.string(id, 'id');
