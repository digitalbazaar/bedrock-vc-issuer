...
export class ListManager {
  ...
  async _getListManagementDoc() {
    ...
    const {statusListConfig: {indexAllocator, type: listType, options}} = this;
    ...
    while(true) {
      ...
      // track list assignment when using `TerseBitstringStatusList`
      if(listType === 'TerseBitstringStatusList') {
