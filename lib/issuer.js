...
// FIXME: "registering" should create an issuer "instance" for a particular
// entity (org, etc.)... these are currently called "instances" and we
// may move it to "instances". This instance should include one or more
// controllers and it should have its own did:key for doing things; that
// did:key should be given a delegatable zcap to read/write to an EDV,
// and a delegatable zcap for issuing VCs using a key
// ... there is no "account" ... only controllers of an "instance" ...
// anyone that can DIDAuth over CHAPI can create an instance
