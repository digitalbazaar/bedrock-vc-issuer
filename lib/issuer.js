...
exports.issueNew = async ({credentials, profileAgentRecord}) => {
  ...
  const assertionMethodZcap = userDoc.content.zcaps['key-assertionMethod'];
  if(!assertionMethodZcap) {
  ...
  console.log('VVVVv', verifiableCredential);
  return verifiableCredential;
};
